<template>
    <v-container>
        ...
        <v-row v-for="order of completedOrders" :key="order.orderID">
...
<script>
    ...
    export default {
        ...
        methods: {
            cancelCompleteOrder(orderID) {
                axios.post('admin/cancelCompletedOrder', orderID, {
            ...
            deleteOrder(orderID) {
                axios.post('admin/deleteCompletedOrder', orderID, {
                    headers: this.headers
                })
                    .then((response) => {
